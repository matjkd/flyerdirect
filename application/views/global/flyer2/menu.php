<ul>
    <li>
        <div style="float:left; padding-top:3px;"><img src="<?= base_url() ?>images/icons/icons/radar.png"/></div>
        <div style="float:left; padding-top:7px; padding-left:10px;"><a target="_blank" href="http://mytrackpanel.com/trackit247/">tracker</a></div>
        <div style="float:left; height:33px;"><img height="33px" src="<?= base_url() ?>images/icons/nav-arrow.png"/></div>
    </li>
</ul>
